...
import { FolderManager } from '@/components/modules/assets/FolderManager'
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {/* Folder Manager for Assets Page */}
          {pathname?.startsWith('/assets') && (
            <div className="p-4 border-t border-gray-200">
              <FolderManager
                projectId="default" // Make this dynamic based on selected project
                currentFolderId={null} // This should be managed by the assets page
                onFolderSelect={() => {}} // This should be connected to the assets page
                onFolderChange={() => {}}
              />
            </div>
          )}
